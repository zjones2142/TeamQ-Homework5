...
public class MotorBike extends Vehicle {
	...
	public MotorBike(String model, String make, long modelYear, double price, VehicleColor color, FuelType fuelType,
	...
	public double calculateMaintenaceCost(double distance) {
		...
		maintenanceCost = distance*this.getMass()*(2024-this.getModelYear())*this.getCylinders()*0.0002;
	...
	public double calculateFuelEfficiency(double distance, double fuelPrice) {
		...
		fuelEfficiency = this.getCylinders()*this.getGasTankCapacity()*fuelPrice / distance * 0.001;
